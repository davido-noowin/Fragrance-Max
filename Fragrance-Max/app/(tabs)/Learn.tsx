    ...
    <SafeAreaView>
      <ScrollView>
        <View>
          ...
          <Text>
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Parfum:</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Eau de Cologne (EDC):</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Eau de Parfum (EDP):</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Eau de Toilette  (EDT):</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Fragrance Families:</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Drydown:</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Projection:</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Skin Scent:</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Logentivity:</Text>
            {'\n'}
            ...
            {'\n'}
            <Text style={[styles.termText, { color: textColor}]}>Sillage:</Text>
            {'\n'}
